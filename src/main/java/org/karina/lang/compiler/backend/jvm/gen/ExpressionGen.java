...
public class ExpressionGen {
    ...
    public ExpressionGen(BytecodeBackend backend) {
        this.backend = backend;
    }

    public void addExpression(KExpr expr, CompileContext ctx) {
    ...
    private static void binary(BinaryOperator operator, BinaryOperatorSet set, CompileContext ctx) {
        switch (operator) {
            case ADD -> {
    ...
    private static void addEquals(CompileContext ctx, LabelNode falseLabel) {
