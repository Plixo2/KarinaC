...
public class RewriteExpr {

    public static KExpr rewrite(@NotNull KExpr expr, RewriteContext context) {
        return switch (expr) {
    ...
    private static KExpr rewriteClosure(KExpr.Closure closure, RewriteContext context) {
