...
public class PostProcessor {
    ...
    private KTree.KUnit rewriteUnit(KTree.KPackage root, KTree.KUnit unit, ObjectPath baseInterfacePath) {
        ...
        PostContext ctx = new PostContext(baseInterfacePath, unit.path());
    ...
    private static KTree.KFunction rewriteFunction(KTree.KFunction function, PostContext ctx) {

        KExpr expr = null;
        if (function.expr() != null) {
            expr = PostExpr.rewrite(function.expr(), ctx);
        }
    ...
    private static KTree.KStruct rewriteStruct(KTree.KStruct struct, PostContext ctx) {
    ...
    private static KTree.KInterface rewriteInterface(KTree.KInterface interface_, PostContext ctx) {
        var functions = new ArrayList<KTree.KFunction>();
